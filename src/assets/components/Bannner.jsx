    ...
    <div className=' min-h-screen bg-gradient-to-br from-gray-900 to-blue-900/30 relative overflow-hidden'>
        ...
        <div className=' container mx-auto px-4 h-screen flex items-center'>
            <div className=' grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 w-full'>
                ...
                {/* IMAGE CONTAINER */}
                <div className=' md:col-span-1 lg:col-span-2 h-64 sm:h-80 md:h-[600px] lg:h-[700px] relative flex
                items-center justify-center '>
                    ...
                    transition={{
                        ...
                        <div className=' absolute inset-0 rounded-3xl backdrop-blur-xl overflow-hidden'>
                            <img src="banner.png" alt="book" className=' w-full h-full object-contain p-8' />
                        </div>
